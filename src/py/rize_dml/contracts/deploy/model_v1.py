...
def deploy_new_model_v1(deployer: Account, name: str, member_address: List[str]) -> ModelRegistryV1:
    factory_meta = load_contract_data("ModelRegistryFactory","smart_contracts/output/local")

    w3 = Web3(Web3.HTTPProvider('http://127.0.0.1:8545'))

    factory = w3.eth.contract(
        abi=factory_meta.abi,
        address=factory_meta.address
    )
