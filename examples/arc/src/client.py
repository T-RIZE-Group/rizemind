...
def client_fn(context: Context):
    ...
    Trainers never send a transaction: they sign EIP-712 messages that the
    aggregator submits. Their accounts therefore need no USDC on Arc.
    """
    ...
    # Account 0 is the aggregator, so trainer `i` uses account `i + 1`.
