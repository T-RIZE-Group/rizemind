...
# Federated Learning with PyTorch Lightning, Opacus and Flower (Quickstart Example)
...
The added DPStrategy aims to provide increased Privacy for trainers with great developer experience as it only changes one line of code as opposed to the way to integrate that Opacus presents.

The problem is that this seems to create a memory leak... needs work
