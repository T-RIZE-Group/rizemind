...
def load_partition(idx: int):
    ...
    dataset_path = f'/home/iman/projects/kara/Projects/T-Rize/archive/City_data/subset_{idx}.csv'
    ...
    x_train = partition_train.drop(columns='Price').values
    y_train = partition_train['Price']
    x_test = partition_test.drop(columns='Price').values
    y_test = partition_test['Price']
...
def create_mlp_model(input_dim):
    ...
    model = Sequential()
    model.add(Conv1D(64, kernel_size=3, padding='same', activation='relu', input_shape=(input_dim, 1)))
