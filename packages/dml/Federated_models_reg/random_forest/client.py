...
if __name__ == "__main__":
    ...
    dataset = pd.read_csv(f'/home/iman/projects/kara/Projects/T-Rize/sklearn-logreg-mnist/City_data/subset_{args.partition_id}.csv')
    ...
    class PricePredictionClient(fl.client.NumPyClient):
    ...
    fl.client.start_client(
        server_address="0.0.0.0:8080", client=PricePredictionClient().to_client()
    )
