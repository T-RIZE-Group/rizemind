...
def main() -> None:
    ...
    fl.server.start_server(
        ...
        strategy=strategy,
        certificates=(
            Path("/home/iman/projects/kara/Projects/T-Rize/federated_models_classification/FedProx/CNN/.cache/certificates/ca.crt").read_bytes(),
            Path("/home/iman/projects/kara/Projects/T-Rize/federated_models_classification/FedProx/CNN/.cache/certificates/server.pem").read_bytes(),
            Path("/home/iman/projects/kara/Projects/T-Rize/federated_models_classification/FedProx/CNN/.cache/certificates/server.key").read_bytes(),
        ),
    )
...
def get_evaluate_fn(model, pool_size):
    ...
    def evaluate(
        ...
        print()
        model_path = f"/home/iman/projects/kara/Projects/T-Rize/federated_models_classification/FedProx/CNN/global_models/global_model/global_model_{server_round}.h5"
