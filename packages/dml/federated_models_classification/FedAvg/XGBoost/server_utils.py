...
def get_evaluate_fn(test_data):
    ...
    def evaluate_fn(
        ...
        if server_round == 0:
            ...
            model_filename = f"/home/iman/projects/kara/Projects/T-Rize/federated_models_classification/FedAvg/XGBoost/global_models/global_model_round_{server_round}.pkl"
            with open(model_filename, "wb") as file:
                pickle.dump(bst, file)
            log(INFO, f"Global model saved as {model_filename}")
            return 0, {"acc": accuracy}
