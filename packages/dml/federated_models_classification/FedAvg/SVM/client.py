...
if __name__ == "__main__":
    ...
    dataset = pd.read_csv(f'/home/iman/projects/kara/Projects/T-Rize/archive/City_data_classification/subset_{partition_id}.csv')
    ...
    inputs = dataset.drop(columns="price_label")
    print(f'train data on client number {partition_id}', inputs.shape[1])
    labels = dataset["price_label"]
    ...
    class SVCClient(fl.client.NumPyClient):
    ...
    fl.client.start_client(
        server_address="0.0.0.0:8080", client=SVCClient().to_client()
    )
