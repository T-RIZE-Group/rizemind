...
def main() -> None:
    ...
    fl.server.start_server(
        ...
        strategy=strategy,
        certificates=(
            Path("/home/iman/projects/kara/Projects/T-Rize/federated_models_classification/FedAvg/MLP/.cache/certificates/ca.crt").read_bytes(),
            Path("/home/iman/projects/kara/Projects/T-Rize/federated_models_classification/FedAvg/MLP/.cache/certificates/server.pem").read_bytes(),
            Path("/home/iman/projects/kara/Projects/T-Rize/federated_models_classification/FedAvg/MLP/.cache/certificates/server.key").read_bytes(),
        ),
    )
...
def get_evaluate_fn(model, pool_size):
    ...
    def evaluate(
        ...
        print()
        model_path = f"/home/iman/projects/kara/Projects/T-Rize/federated_models_classification/FedAvg/MLP/global_models/global_model_{server_round}.h5"
