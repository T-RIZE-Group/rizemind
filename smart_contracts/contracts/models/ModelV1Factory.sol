...
contract ModelRegistryFactory {
    ...
    event ContractCreated(address indexed proxyAddress, address indexed owner, string name);
    ...
    function createModel(    
        ...
        bytes memory data = abi.encodeWithSelector(
            ModelRegistryV1.initialize.selector, name, symbol, aggregator, initialTrainers
        );
